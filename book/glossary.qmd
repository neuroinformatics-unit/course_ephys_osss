...
![A Neuropixels probe, with the electrodes (labelled 'sites') visible on the left-hand image. The two plots on the right show the r.m.s and impedance across the electrodes. From [Jun et. al (2017)](https://www.researchgate.net/figure/The-Neuropixels-probe-a-Illustration-of-probe-tip-showing-checkerboard-site-layout_fig10_320932484)](images/glossary-electrodes.png){width="60%"}
...
![Recording electrodes *(left)* with the corresponding recorded data *(right)* labelled 'channels'. From [Neto et. al (2016)](https://pubmed.ncbi.nlm.nih.gov/27306671/)](images/glossary-channel.png){width="75%"}
...
![*left* A raster plot with trial number on the y-axis. This neuron displays time-locked activation associated with a behavioural event at time 0.0. *right* A raster plot with spike position (depth along the probe) on the y-axis. This 'driftmap' is a useful way to assess probe motion.](images/glossary-raster.png){width="90%"}
