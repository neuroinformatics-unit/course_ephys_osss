...
in fact introduced an artefact around the XXX mark. In general if the drift plots in your
...
Further, motion correction  may inject erroneous contamination when motion is miscalculated, resulting in a vertical 'smearing' of spikes in the raster plot.
