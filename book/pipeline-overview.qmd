...
We will use a [short example dataset](course-data.qmd#introductory-dataset) available on 
...
**phase_shift** : corrects a hardware artifact in the Neuropixels probe 
...
- What happens if you set the bandpass filter minimum cutoff to zero? What frequencies are included now? Or set the maximum cutoff to 15000?
...
- Save the data to disk with the Recording object's `.save()` method
