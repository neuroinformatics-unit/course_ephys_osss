...
*14:00 - 14:45* : (lecture, Alessio) Overview of spike sorting and spike sorting steps

(some of this is touched on in the first session, so we can reduce it there or change the emphasis of this talk)

* Why we need to do it
* The key outputs (spike times, unit assignment, templates (also can mention waveforms / snippets, extensions - except metrics))
* It is a hard problem - many sorters exist
* We can use spikeinterface to run and compare various sorters
* (The SortingComponents project: overview and results)


*14:45 - 15:30* : (coding) Run a couple of different sorters in SpikeInterface and compare the outputs using sorting comparison, and instantiate a SortingAnalyzer and compute extensions.
...
*15:40 - 17:00* : (lecture / coding, Enny) UnitMatch
