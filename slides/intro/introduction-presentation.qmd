...
## Extracellular electrophysiological data {data-transition="slide-in none-out"}
...
::: {.math-goal-quote .math-goal-quote-lower}
...
## Coding a pipeline with SpikeInterface {.section-title-slide}
...
![](images/spikeinterface-common-api.png){fig-alt="SpikeInterface common API for open-source electrophysiological tools" style="display: block; width: 100%; max-height: 700px; margin: 0 auto; object-fit: contain;"}
...
## Downloading data for the course {.section-title-slide}
