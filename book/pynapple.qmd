...
If you use Claude, you can add the Pynapple `claude-skills` [plugin](https://github.com/pynapple-org/claude-skills) to make it more aware of the Pynapple API.
...
Pynapple has a lot [more learning material](), take a look here if you want to become an expert!
