...
::: {style="max-width: 620px; margin: 0.4rem auto 0;"}
...
::: {style="max-width: 540px; margin: 0.25rem 0 0.35rem 1.5rem;"}
...
::: {style="max-width: 980px; margin: 0.4rem auto 0;"}
...
<table style="width: 100%; border-collapse: separate; border-spacing: 1.2rem 0.45rem;">
  ...
  <tbody>
    ...
    <tr>
      <td style="padding: 0.15rem 0.35rem;"><strong>Session 5: Analyzing outputs (Pynapple and Probe-anatomy alignment)</strong></td>
...
Head to the 'Python set up' page and we will go through it together.


## Notes on the coding section

- Typing code is a powerful way to build understanding and muscle memory. Try not to copy and paste from the book, or use AI.
- If you have your own data, feel free to apply the methods we introduce to it during the course, and ask us questions about it!
