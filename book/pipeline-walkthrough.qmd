...
import numpy as np
templates = np.load(r"C:\Users\Joe\work\git-repos\course-ephys-osss\book\kilosort4_output\sorter_output\templates.npy")

for i in range(waveforms.shape[0]):

    plt.imshow(waveforms[i, :, :].T, aspect="auto")
    plt.show()
...
for i in range(analyzer.sorting.get_num_units()):
    si_widgets.plot_unit_templates(analyzer, unit_ids=[i])
    plt.show()
