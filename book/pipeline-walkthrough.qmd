...
See the set up instructions to [download the course repository.](setup.qmd#download-the-repository)

This [recording](course-data.qmd#introductory-dataset) is a 2.5 second period from a 384 channel 4-shank Neuropixels 2 probe acquired
