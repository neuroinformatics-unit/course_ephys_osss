# Neural analysis with Pynapple (coding)
...
This dataset can be downloaded from the [course data Zenodo](https://zenodo.org/records/21908611), 
filename: `dandiset-000939-no-traces-full.nwb`. See [here](course-data.qmd#spike-times-and-behavior-used-in-the-pynapple-section) for more details on data provenance. 
...
If you are not satisfied and want to learn more, we are keeping track of all the [Pynapple learning material here](https://pynapple.org/learning_material.html).
